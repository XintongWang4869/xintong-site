...
.About This Document
--
* *Summary:* A high-level overview of Ethernet switch functions in automotive networks, emphasizing their role in enabling reliable and secure in-vehicle communication.
* *Intended Audience:* Technical professionals or readers seeking a foundational understanding of automotive Ethernet switch functions.
* *Written Context:* A self-initiated conceptual overview, created as a writing sample rather than a detailed specification or design guide.
--
...
[NOTE]
====
. ***Strict priority (SP)***: A scheduling algorithm, always sending higher-priority traffic before lower-priority traffic; lower-priority traffic may be delayed or starved.

. ***Weighted Round-Robin (WRR)***: A scheduling algorithm, assigning bandwidth proportionally to ensure all traffic types get a guaranteed share while still prioritizing critical messages.
====
